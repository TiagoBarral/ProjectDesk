  ...
  return (
    <main className="detail">
      ...
      <div className="content">
        ...
        {activeTab === 'files' && <FilesTab project={project} userId={props.userId} workspaceId={props.workspaceId} onAddFiles={props.onAddFiles} onDeleteFile={props.onDeleteFile} onUpdateFile={props.onUpdateFile} openModal={props.openModal} />}
      </div>
    </main>
  );
}
